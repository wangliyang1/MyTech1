 ...
 * function:
 */
public class FindTitleFragment extends BaseFragment<TechPresenter> {
    ...
    protected int layoutId() {
        return R.layout.fragment_find_title;
    }
    ...
    public void onUserEvent(Search event) {
        if (event.getName() != null) {
            ...
            map.put("page", 1);
            map.put("count", 5);
            mPresenter.getDoParams(MyUrls.CONSULT_FIND_TITLE, FindByTitleBean.class, map);
        } else {
